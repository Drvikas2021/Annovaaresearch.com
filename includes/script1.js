...
var spark1 = {
  ...
  series: [{
    data: [1337024, 1385635, 1424202, 1437976, 1487976, 1533936]
  }],
  stroke: {
    curve: 'smooth'
  },
...
var spark2 = {
  ...
  series: [{
    data: [849432, 885573, 885577, 918906, 989624]
  }],
  stroke: {
    curve: 'smooth'
  },
...
var spark3 = {
  ...
  series: [{
    data: [31358, 32060, 32063, 32826, 32425, 34240]
  }],
  stroke: {
    curve: 'smooth'
  },
...
var optionsLine = {
  ...
  series: [{
      name: "Confirmed",
      data: [1337024, 1385635, 1424202, 1437976, 1485632, 1533936]
    },
    {
      name: "Recovered",
      data: [849432, 885573, 885577, 918906, 952743, 989624]
    },
    {
      name: "Mortality",
      data: [31358, 32060, 32063, 32826, 33425, 34240]
    }
  ],
  title: {
    text: 'Corona',
  ...
  labels: ['24/07/2020', '25/07/2020', '26/07/2020', '27/07/2020', '28/07/2020', '29/07/2020'],
  xaxis: {
    tooltip: {
      enabled: false
    }
